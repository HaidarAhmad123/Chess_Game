...
var darkSquaresOdd = document.querySelectorAll('#board .even div:nth-child(odd)' )
var darkSquareseven =document.querySelectorAll('#board .odd div:nth-child(even)')
var lightSquaresOdd = document.querySelectorAll('#board .odd div:nth-child(odd)' )
var lightSquareseven =document.querySelectorAll('#board .even div:nth-child(even)')
...
function changeColor1(){
	darkSquaresOdd.forEach((square)=>{
		square.style.background = '#6f73d2'
	})
	darkSquareseven.forEach((square)=>{
		square.style.background = '#6f73d2'
	})
	lightSquaresOdd.forEach((square)=>{
		square.style.background = '#9dacff'
	})
	lightSquareseven.forEach((square)=>{
		square.style.background = '#9dacff'
	})
}
function changeColor2(){
	darkSquaresOdd.forEach((square)=>{
		square.style.background = '#706677'
	})
	darkSquareseven.forEach((square)=>{
		square.style.background = '#706677'
	})
	lightSquaresOdd.forEach((square)=>{
		square.style.background = '#ccb7ae'
	})
	lightSquareseven.forEach((square)=>{
		square.style.background = '#ccb7ae'
	})
...
function changeColor3(){
	darkSquaresOdd.forEach((square)=>{
		square.style.background = '#b88b4a'
	})
	darkSquareseven.forEach((square)=>{
		square.style.background = '#b88b4a'
	})
	lightSquaresOdd.forEach((square)=>{
		square.style.background = '#e3c16c'
	})
	lightSquareseven.forEach((square)=>{
		square.style.background = '#e3c16c'
	})
...
function changeColor4(){
	darkSquaresOdd.forEach((square)=>{
		square.style.background = '#707070'
	})
	darkSquareseven.forEach((square)=>{
		square.style.background = '#707070'
	})
	lightSquaresOdd.forEach((square)=>{
		square.style.background = '#ccd'
	})
	lightSquareseven.forEach((square)=>{
		square.style.background = '#ccd'
	})
